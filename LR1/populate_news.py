#!/usr/bin/env python
"""
Скрипт для заполнения базы данных новостями с случайными изображениями
"""
import os
import sys
import django
...
def populate_news():
    ...
    # Устанавливаем пароль для админа, если создан новый пользователь
    if created:
